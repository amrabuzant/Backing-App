...
public class configactivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView=(RecyclerView)findViewById(R.id.recipeConfigRecyclerView);
        ...
        itemclick.addTo(recyclerView).setOnItemClickListener(new itemclick.OnItemClickListener() {
            @Override
    ...
    private void showWidgwt(int position){
        ...
        if (bundle!=null){
            ...
            widgetProvider.updatePlantWidgets(this, appWidgetManager,recipeIngredient,array,bundle1);
